# skill-iteration-governance Specification

## Purpose
Define the OpenSpec lifecycle and repository boundaries used for significant skill behavior and distribution changes.
## Requirements
