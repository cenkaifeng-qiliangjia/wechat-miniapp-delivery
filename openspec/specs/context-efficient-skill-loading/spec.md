# context-efficient-skill-loading Specification

## Purpose
Keep skill entrypoints focused and economical while preserving the routing, safety, and acceptance behavior needed for reliable delivery.
## Requirements
